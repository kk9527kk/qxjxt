          ...
          <form action="rysave1.asp?id=<%=lid%> "  method="post">
            <tr>
              <td width="281" background="images/bg1.gif" height="21">
                <p align="center"><b>用户</b><b>信息修改</b></td>
            </tr>
          </center>
            <tr>
...
%>  
                ...
                <table border="0" width="100%" height="92">
                  <tr>
                    <td width="30%" align="right" valign="bottom" height="1">姓名：</td>
                  ...
                  <tr>
                    <td width="30%" align="right" valign="bottom" height="16">账号：</td>
                  ...
                  <tr>
                    <td width="30%" align="right" valign="bottom" height="16">职务：</td>
                    <td width="70%" height="16">
                      <p><select size="1" name="zw">                       
                        <option value="1" <%if zw=1 then%>selected<%end if%>>一般职工</option>
                        <option value="2" <%if zw=2 then%>selected<%end if%>>科所长副职</option>
                        <option value="3" <%if zw=3 then%>selected<%end if%>>科所长</option>
                        <option value="4" <%if zw=4 then%>selected<%end if%>>分管局领导</option>
                        <option value="5" <%if zw=5 then%>selected<%end if%>>局长</option>
                        <option value="6" <%if zw=6 then%>selected<%end if%>>人教科科长</option>
                        <option value="7" <%if zw=7 then%>selected<%end if%>>人教科管理员</option>
                      </select></td>
                  </tr>
                </table>
