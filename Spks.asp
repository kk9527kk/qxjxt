...
前往何地：(<font color="#FF00FF">&nbsp;<%=rs("qWHD")%></FONT>)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 离开云阳标志：(<font color="#FF00FF">&nbsp;<%=SFLFJ1%></FONT>)    </td>                              
  </tr>
  <tr>
  ...
  <tr>
  <form method="POST" action="saveKS.asp?id=<%=lid%>" name="form1">
    <td width="811" bordercolorlight="#000000" height="1" colspan="2">
      单位负责人意见： 同意<input type="radio" value="1" name="KS" checked>，不同意<input type="radio" name="KS" value="0">&nbsp;&nbsp;&nbsp;     
      具体意见为：<textarea rows="2" name="KSyj" cols="58"></textarea>                    
      <p>&nbsp;签名：<%=zg%>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   
      时间：<%=DATE()%>
    </td>
