...
dw1=request.cookies("dw1")
qjlb1=request.cookies("qjlb1") 
...
<table border="0" id="table1" align="center" cellspacing="0" cellpadding="0" width="819">
  <tr>
    <td width="817">
      <p align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
      <a href="cxquit.asp"><font color="#000080" size="2">:::按申请时间统计:::</font></a>&nbsp;&nbsp;&nbsp;&nbsp;</p>         
    </td>
  </tr>
</table>
<div align="left">
    <table border="0" width="743"  align="center" cellspacing="1" cellpadding="0" bgcolor="#000000">
      <tr> 
        ...
        <td width="33.33%" bgcolor="#FFFFFF" height="23" background="gdzc/images/bg1.gif" align="center">实休天数</td>

             </tr>
             
             
             <% if dw1=""  and qjlb1="" then
                 bds="(QJzt='5' OR   QJzt='6' OR QJzt='7')  and qjsjq between #"&rqq&"#"&" and #"&rqz&"#"  
                elseif  dw1=""  and qjlb1<>"" then
                 bds="(QJzt='5' OR   QJzt='6' OR QJzt='7')  AND QJLB='"&QJLB1&"' and qjsjq between #"&rqq&"#"&" and #"&rqz&"#"  
                elseif dw1<>"" and qjlb1<>"" then
                  bds="(QJzt='5' OR   QJzt='6' OR QJzt='7')  and  dw='"&dw1&"' AND QJLB='"&QJLB1&"' and qjsjq between #"&rqq&"#"&" and #"&rqz&"#"  
                else
                 bds="(QJzt='5' OR   QJzt='6' OR QJzt='7')  and  dw='"&dw1&"' and qjsjq between #"&rqq&"#"&" and #"&rqz&"#"  
                end if
...
Arr=split(Arr,",") 
  %> 
    <% for   n=0   to   UBound(arr)   %>        
          <% if dw1=""  and qjlb1="" then
                 bds="(QJzt='5' OR   QJzt='6' OR QJzt='7')  and qjsjq between #"&rqq&"#"&" and #"&rqz&"#"&"  and zg='"&arr(n)&"'" 

                elseif  dw1=""  and qjlb1<>"" then
                 bds="(QJzt='5' OR   QJzt='6' OR QJzt='7')  AND QJLB='"&QJLB1&"' and qjsjq between #"&rqq&"#"&" and #"&rqz&"#"&"  and zg='"&arr(n)&"'" 

                elseif dw1<>"" and qjlb1<>"" then
                  bds="(QJzt='5' OR   QJzt='6' OR QJzt='7')  and  dw='"&dw1&"' AND QJLB='"&QJLB1&"' and qjsjq between #"&rqq&"#"&" and #"&rqz&"#"&"  and zg='"&arr(n)&"'" 

                else
                 bds="(QJzt='5' OR   QJzt='6' OR QJzt='7')  and  dw='"&dw1&"' and qjsjq between #"&rqq&"#"&" and #"&rqz&"#"&"  and zg='"&arr(n)&"'" 
      ...
      <tr> 
        <td width="33.33%" bgcolor="#FFFFFF" height="20" align="center">　<a href="zgcxcl1.asp?zg='<%=arr(n)%>'"><%=arr(n)%></td>
        <td bgcolor="#FFFFFF" height="20" align="center" width="33.33%"><%=sl%>　</td>
        <td bgcolor="#FFFFFF" height="20" align="center" width="33.33%"><%=sl1%>　</td>
     </tr>
...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                          
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
特别说明：以上数据以休假起时间为依据。请假天数是审批同意休假的天数，而实休天数是人教科销假录入的天数。</p>
</body>       
