...
<p align="center"><b>申请时间:从<%=rqq1%>到<%=rqz1%>        </b>        </p>
	...
	<tr>
		<td width="757">
<br>
<p align="right"><a href="javascript:history.go(-1);">返回上一页
        </td>
	</tr>
</table>
    ...
    <table border="0" width="775"  align="center" cellspacing="1" cellpadding="0" bgcolor="#000000">
      <tr> 
        ...
        <td width="80" bgcolor="#FFFFFF" height="23" background="gdzc/images/bg1.gif" align="center">休假时间止</td>
        <td width="85" bgcolor="#FFFFFF" height="23" background="gdzc/images/bg1.gif" align="center">请假天数</td>

        <td width="79" bgcolor="#FFFFFF" height="23" background="gdzc/images/bg1.gif" align="center">实休天数</td>

		<td width="236" bgcolor="#FFFFFF" height="23" background="gdzc/images/bg1.gif" align="center"> 审批状态</td>
		...
		<td width="88" bgcolor="#FFFFFF" height="23" background="gdzc/images/bg1.gif" align="center"> 销假日期</td>
          ...
          sql="select *  from qxjdjb  where zg="&zg1&" and qjsjq between #"&rqq&"#"&" and #"&rqz&"#"&"   order by id desc"
          set rs=server.createobject("adodb.recordset")
          rs.open sql,connstr,1,1
       if rs.eof then
      %>
      <tr> 
        <td bgcolor="#FFFFFF" colspan="8" width="769"> 
 ...
 %>
     <tr>
       ...
       <a href="cx.asp?id=<%=rs("id")%>"> <font color="#008080">
        ...
        <td width="80" bgcolor="#FFFFFF" height="23" align="center">   <%=rs("qjsjz")%>　</td>
        <td width="85" bgcolor="#FFFFFF" height="23" align="center">　  <%=rs("TS")%></td>
        <td width="79" bgcolor="#FFFFFF" height="23" align="center">　<%=rs("SXTS")%></td>
		<td width="236" bgcolor="#FFFFFF" height="23" align="center">　<%=QJZT1%> </td>
  ...
  <tr>
    <td width="464">页数：<%=currentpage%>
      ...
      <%k=currentpage                                                                                                                                                                                  
   	if k<>1 then%>
      [<a href="zgcxcl1.asp?pageid=1">首页</a>] [<a href="zgcxcl1.asp?pageid=<%=k-1%>">上一页</a>]                                                                                                                    
      <%else%>
      [首页]&nbsp;[上一页] <%end if%>                                                                                                                   
      <%if k<>n then%>                                                                                                                   
      [<a href="zgcxcl1.asp?pageid=<%=k+1%>">下一页</a>] [<a href="zgcxcl1.asp?pageid=<%=n%>">尾页</a>]                                                                                                                    
      <%else%>
      [下一页]&nbsp;[尾页] <%end if%>                                                                                                                   
    ...
    <td height="23" width="302">
      ...
      <p align="right"><select onChange="pagei()" size="1" name="pag" style="background-attachment: scroll; background-repeat: repeat; font-size: 9pt; height: 16; width: 77; background-color: #FFFFFF; border: 1 solid #000000; background-position: none 0%">
        <%                                                                                                                                                            
          ...
          do while not i > n
          %>
        <option value="zgcxcl1.asp?pageid=<%=i%>" <%if i=currentpage then %>selected<%end if%>>第 
        <%=i%> 页</option>
        <%
          i=i+1
          loop
