...
<table align="center" border="1" width="750" cellspacing="0" cellpadding="0" bordercolorlight="#000000" bordercolor="#FFFFFF" height="232">
  <tr>
    <td width="811" bordercolorlight="#000000" height="36" background="images/bg1.gif" colspan="2">
      <p align="center"><font color="#0000FF" face="黑体" size="6">云阳县国家税务局职工请销假审批表</font>
...
需局长审批标志：(<font color="#FF00FF">&nbsp;<%=SFLFJ1%></FONT>)    </td>                                               
  ...
  <tr>
    <td width="811" bordercolorlight="#000000" height="1" colspan="2">
      人教科意见： (<font color="#FF00FF">&nbsp;<%=RS("RJYJ")%></FONT>)                                    
      <p>&nbsp;签名：<font color="#FF00FF">&nbsp;<%=RS("RJ")%></FONT>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 时间：<font color="#FF00FF">&nbsp;<%=DATe()%>  </FONT>                 
    </td>
  </tr>
  <tr>
    <td width="811" bordercolorlight="#000000" height="1" colspan="2">
      分管领导意见： (<font color="#FF00FF">&nbsp;<%=rs("fgldyj")%></font>)                          
      <p>&nbsp;签名：<font color="#FF00FF">&nbsp;<%=rs("fgld")%></font>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 时间：<font color="#FF00FF">&nbsp;<%=rs("fgldrq")%></font>         
    </td>
  </tr>
  <tr>
    <td width="811" bordercolorlight="#000000" height="1" colspan="2">
      分管领导意见： 同意<input type="radio" value="1" name="KS" checked>，不同意<input type="radio" name="KS" value="0">&nbsp;&nbsp;         
      在此填上具体意见<textarea rows="2" name="KSyj" cols="57"></textarea>                  
      <p>&nbsp;签名：<%=zg%>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 时间：<%=DATe()%> 
    </td>
  </tr>
