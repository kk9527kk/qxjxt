...
<div align="left">
  ...
  <tr>
    <td width="100%" colspan="2">
      <p align="center"><input type="submit" value=" 修 改  " name="edit" style="background-color: #DDDDDD; background-repeat: repeat; background-attachment: scroll; font-size: 9pt; height: 20; width: 71; background-image: url('images/bg1.gif'); border: 1px groove #000000; background-position: 0% 50%">&nbsp;&nbsp;   
      <input type="reset" value=" 取 消 " name="reset" style="background-color: #DDDDDD; background-repeat: repeat; background-attachment: scroll; font-size: 9pt; height: 20; width: 71; background-image: url('images/bg1.gif'); border: 1px groove #000000; background-position: 0% 50%"></p>              
    </td>              
  </tr></form>              
                    </table>              
                  </td>              
