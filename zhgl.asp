...
<table border="0" id="table1" align="center" cellpadding="0" width="713">
	<tr>
		<td width="711">
          ...
          云阳县国家税务局账号管理</font><p align="center">　
        </td>
	</tr>
</table>
<div align="left">
    <table border="0" width="715" align="center" cellpadding="0" bgcolor="#000000" cellspacing="1">
      <tr> 
        ...
        <td width="143" bgcolor="#FFFFFF" height="23" background="images/bg1.gif" align="center">姓名</td>
        <td width="143" bgcolor="#FFFFFF" height="23" background="images/bg1.gif" align="center">角色</td>
    ...
    if rs.eof then
      %>
      <tr> 
        <td bgcolor="#FFFFFF" colspan="6" width="352"> 
...
%>
      ...
      <tr> 
        ...
        <td bgcolor="#FFFFFF" height="20" align="center" width="143"><%=zw1%>　</td>
        <td bgcolor="#FFFFFF" height="20" align="center" width="143"><%=rs("xh")%></td>
        <td width="143" bgcolor="#FFFFFF" height="20" align="center"><a href="ryedit.asp?id=<%=rs("id")%>">编辑</a>|<a href="rydel.asp?id=<%=rs("id")%>"><font color="red">删除</font></a></td>
        <%
      i=i+1
    rs.movenext
    loop
...
<div align="left">
  <table border="0" width="713" align="center" cellpadding="0">
    ...
    <td width="464" align="left">页数：<%=currentpage%>/<% =n%>
   	<%k=currentpage                                                 
   	if k<>1 then%>
   	[<a href="zhgl.asp?pageid=1">首页</a>]                                                 
   	[<a href="zhgl.asp?pageid=<%=k-1%>">上一页</a>]                                                 
   	<%else%>
   	[首页]&nbsp;[上一页]                                                 
   	<%end if%>
   	<%if k<>n then%>                                                 
   	[<a href="zhgl.asp?pageid=<%=k+1%>">下一页</a>]                                                 
   	[<a href="zhgl.asp?pageid=<%=n%>">尾页</a>]                                                 
   	<%else%>
   	[下一页]&nbsp;[尾页]                                                 
   	<%end if%>
      ...
      <td height="23" width="245" align="left">  
        ...
        <select onChange="pagei()" size="1" name="pag" style="background-attachment: scroll; background-repeat: repeat; font-size: 9pt; height: 16; width: 77; background-color: #FFFFFF; border: 1 solid #000000; background-position: none 0%">  
          ...
          do while not i > n
          %>
          <option value="zhgl.asp?pageid=<%=i%>" <%if i=currentpage then %>selected<%end if%>>第 
          <%=i%> 页</option>
          <%
          i=i+1
          loop
  ...
  <center>
       <tr>
      <td width="711" colspan="2" align="left"><a href="ryadd.asp"><font color="#000080">添加账号信息</font></a><font color="#000080">   
 </font>                        
      </td>                     
    </tr>         
